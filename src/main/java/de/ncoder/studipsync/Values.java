...
public final class Values {
	public static final String PAGE_COVER = "intelec.uni-passau.de";
	public static final String PAGE_BASE = "studip.uni-passau.de";
	...
	private static final String readResource(String resName) {
		StringBuilder bob = new StringBuilder();
		try (BufferedReader r = new BufferedReader(new InputStreamReader(StudipAdapter.class.getResourceAsStream(resName)))) {
			String line;
